  ...
  <div class="sidebar">
    <nav class="sidebar__block">
      ...
      <ul class="sidebar__links">
        ...
        <li class="sidebar__link" v-show="!isLogged">
        ...
        <li class="sidebar__link">
          <router-link :to="{name: 'cars.index'}">Cars</router-link>
        </li>
        <li class="sidebar__link">
...
<!--        <li class="sidebar__link"><a href="https://webdevetc.com/">Web dev etc blog</a></li>
    ...
    <nav class="sidebar__block" v-if="isLogged">
      <h2 class="sidebar__heading">Profile</h2>

      <ul class="sidebar__links">
        <li class="sidebar__link" v-show="isLogged">
          <router-link :to="{name: 'profile.cars.create'}">Add a car</router-link>
        </li>
        <li class="sidebar__link">
          <router-link :to="{name: 'profile.cars.index'}">Cars</router-link>
        </li>
        <li class="sidebar__link" v-show="isLogged">
